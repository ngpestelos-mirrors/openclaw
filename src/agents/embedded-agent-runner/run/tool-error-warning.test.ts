...
describe("buildEmbeddedRunPayloads tool warnings", () => {
  ...
  it("hides exec command and cwd metadata without full verbosity", () => {
    ...
    expectSinglePayloadSummary(payloads, {
      text: "The Exec step failed (exit 1)",
      isError: true,
    });
  });
  ...
  it("keeps full-verbose exec failure labels outside markdown command text", () => {
    ...
    expectSinglePayloadSummary(payloads, {
      text: "The Exec step failed: `python3 /path/to/daily-cost-audit.py`: Command exited with code 1",
      isError: true,
    });
  ...
  it.each([
    ...
    [undefined, "full", "The Exec step failed: `make build`: Command exited with code 7"],
  ] as const)(
  ...
  it.each([
    {
      ...
      toolResultFormat: "markdown",
      expected: "The Exec step failed: `python3 /tmp/audit.py`: Command exited with code 1",
    },
    {
    ...
    },
    {
      ...
      toolResultFormat: "markdown",
      expected:
        "The Exec step failed: `python3 /tmp/audit.py (in /tmp/build @everyone)`: Command exited with code 1",
    },
  ...
  it("preserves raw exec cwd context before trailing raw command metadata", () => {
    ...
    expectSinglePayloadSummary(cwdPayloads, {
      text: "The Exec step failed: `python3 audit.py (in /tmp/build)`: Command exited with code 1",
      isError: true,
    });
    expectSinglePayloadSummary(workspaceNodePayloads, {
      text: "The Exec step failed: `node: mac-1 · python3 audit.py (workspace)`: Command exited with code 1",
      isError: true,
    });
    expectSinglePayloadSummary(semanticCompactPayloads, {
      text: "The Exec step failed: `git status (repo)`: Command exited with code 1",
      isError: true,
    });
  });
  ...
  it.each([
    {
      ...
      expected: "The Exec step failed: `make build`: Command failed with exit code 2",
    },
    {
      name: "preserves a semantic test summary",
      meta: "run tests",
      error: "Command failed with exit code 1",
      expected: "The Exec step failed: `run tests`: Command failed with exit code 1",
    },
    {
      name: "preserves a semantic deploy summary",
      meta: "run deploy",
      error: "Command failed with exit code 1",
      expected: "The Exec step failed: `run deploy`: Command failed with exit code 1",
    },
    {
      ...
      error: "Command failed with exit code 1",
      expected:
        "The Exec step failed: `run tests → install dependencies`: Command failed with exit code 1",
    },
    {
      name: "preserves an inline-script summary",
      meta: "run node inline script",
      error: "Command failed with exit code 1",
      expected: "The Exec step failed: `run node inline script`: Command failed with exit code 1",
    },
    {
      ...
      error: "Command failed with exit code 1",
      expected:
        "The Exec step failed: `run python3 inline script (heredoc)`: Command failed with exit code 1",
    },
    {
      name: "preserves a sed summary",
      meta: "run sed on file",
      error: "Command failed with exit code 1",
      expected: "The Exec step failed: `run sed on file`: Command failed with exit code 1",
    },
    {
      ...
      error: "Command failed with exit code 1",
      expected:
        "The Exec step failed: `run tests -> show first 3 lines`: Command failed with exit code 1",
    },
  ...
  it("wraps markdown-capable mutating tool warnings so mention-looking names stay inert", () => {
    ...
    expectSinglePayloadSummary(payloads, {
      text: "The Bash step failed: `show matrix-progress-@room-@alice:matrix-qa.test-!room:matrix-qa.test.txt` (workspace): Command exited with code 1",
      isError: true,
    });
  });
