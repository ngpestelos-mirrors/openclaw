...
import { buildSessionCompanionSystemPrompt } from "./session-companion-policy.js";
import {
...
export function createSessionCompanionAskRuntime(params: SessionCompanionAskRuntimeParams) {
  ...
  const run = params.run ?? runSessionCompanionAsk;
