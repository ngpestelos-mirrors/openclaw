...
Startup and hourly cleanup can also reclaim tokenless `openclaw-plugin-build-*`
...
current Windows and recognized container environments. Run cleanup on a host
with complete visibility after stopping the other OpenClaw producers.
