...
import { runToolProgressMentionSafetyScenario, testing } from "./scenario-runtime-tool-progress.js";
...
it("does not reuse events observed before the current progress scenario", () => {
  ...
  const isCurrentScenarioEvent = testing.createCurrentScenarioEventPredicate(observedEvents, 1);
