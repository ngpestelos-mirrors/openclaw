...
import { registerSideQuestionNativePolicyTests } from "./side-question-native-policy.test-support.js";
import {
  createClientHarness,
...
describe("runCodexAppServerSideQuestion", () => {
  ...
  registerSideQuestionNativePolicyTests(handleClientRequestWhenReady);
