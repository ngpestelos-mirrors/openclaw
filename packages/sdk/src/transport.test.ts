...
describe("GatewayClientTransport", () => {
  ...
  it("retires missed-terminal baselines after queued frames cross a connection boundary", async () => {
    ...
    try {
      ...
      const freshWire = createChatEvent("fresh", "session-fresh", 1, "delta", "fresh prefix", 102, {
        deltaText: "prefix",
      });
      rawIterator = oc
